        ...
        <div class="col text-center">
            <div class="col-md-6 offset-3">
              <form action="updatePost.php" method="GET">
                ...
                <p><input id="title" type='text' name='postTitle' value='<?php echo $post['title'];?>' class="form-control"></p>

                <label for="content"><h3>Content</h3></label>
                <p><textarea id="content" class="form-control" name='postContent' rows="7"> <?php echo $post['content']; ?> </textarea></p>
                ...
                if($images != NULL){
                  foreach ($images as $imageID) { // fetcher image paths for et post
                    ...
                    echo "<p><img src='$image_path' class='img-fluid' width='700'></p>";
                  }
                }?>
              ...
              <!--  VIRKER IKKE ORDENTLIGT FUNGERER KUN SOM SEPERAT FUNKTION
              <form action="handlePost.php" method="POST" enctype='multipart/form-data'>
                <p><input id="image" class="form-control" type='file' name='image'></p>
